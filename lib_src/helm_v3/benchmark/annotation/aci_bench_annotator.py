...
ANNOTATOR_MODELS: Dict[str, AnnotatorModelInfo] = {
    # "gpt-4.1-mini": AnnotatorModelInfo(
    #     model_name="openai/gpt-4.1-mini-2025-04-14",
    #     model_deployment="openai/gpt-4.1-2025-04-14",
    # ),
    "gpt-5": AnnotatorModelInfo(
        model_name="openai/gpt-5-2025-08-07",
        model_deployment="openai/gpt-5-2025-08-07",
    ),
    # "claude_opus_4.1": AnnotatorModelInfo(
    #     model_name="anthropic/claude-3-7-sonnet-20250219",
    #     model_deployment="anthropic/claude-3-7-sonnet-20250219",
    # ),
    # "DeepSeek-V3": AnnotatorModelInfo(
